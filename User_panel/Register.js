...
if (passwordValue === "") {
    ...
    isFormValid = false;
  } else if (passwordValue.length < 6) { // Example condition: Minimum 6 characters for the password
    setMessage(messageType.ERROR, password, "Password should be at least 6 characters long");
    isFormValid = false;
  } else {
